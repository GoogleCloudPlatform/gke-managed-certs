...
func (c *FakeManagedCertificates) Get(name string, options v1.GetOptions) (result *v1beta2.ManagedCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) List(opts v1.ListOptions) (result *v1beta2.ManagedCertificateList, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) Create(managedCertificate *v1beta2.ManagedCertificate) (result *v1beta2.ManagedCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) Update(managedCertificate *v1beta2.ManagedCertificate) (result *v1beta2.ManagedCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) UpdateStatus(managedCertificate *v1beta2.ManagedCertificate) (*v1beta2.ManagedCertificate, error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.ManagedCertificate, err error) {
	obj, err := c.Fake.
