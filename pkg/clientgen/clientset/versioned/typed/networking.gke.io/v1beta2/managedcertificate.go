...
type ManagedCertificateInterface interface {
	Create(*v1beta2.ManagedCertificate) (*v1beta2.ManagedCertificate, error)
	Update(*v1beta2.ManagedCertificate) (*v1beta2.ManagedCertificate, error)
	UpdateStatus(*v1beta2.ManagedCertificate) (*v1beta2.ManagedCertificate, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta2.ManagedCertificate, error)
	List(opts v1.ListOptions) (*v1beta2.ManagedCertificateList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.ManagedCertificate, err error)
...
func (c *managedCertificates) Get(name string, options v1.GetOptions) (result *v1beta2.ManagedCertificate, err error) {
...
func (c *managedCertificates) List(opts v1.ListOptions) (result *v1beta2.ManagedCertificateList, err error) {
...
func (c *managedCertificates) Create(managedCertificate *v1beta2.ManagedCertificate) (result *v1beta2.ManagedCertificate, err error) {
	result = &v1beta2.ManagedCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) Update(managedCertificate *v1beta2.ManagedCertificate) (result *v1beta2.ManagedCertificate, err error) {
	result = &v1beta2.ManagedCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) UpdateStatus(managedCertificate *v1beta2.ManagedCertificate) (result *v1beta2.ManagedCertificate, err error) {
	result = &v1beta2.ManagedCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.ManagedCertificate, err error) {
	result = &v1beta2.ManagedCertificate{}
