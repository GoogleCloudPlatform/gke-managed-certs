...
func (c *FakeManagedCertificates) Get(name string, options v1.GetOptions) (result *networkinggkeiov1.ManagedCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) List(opts v1.ListOptions) (result *networkinggkeiov1.ManagedCertificateList, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) Create(managedCertificate *networkinggkeiov1.ManagedCertificate) (result *networkinggkeiov1.ManagedCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) Update(managedCertificate *networkinggkeiov1.ManagedCertificate) (result *networkinggkeiov1.ManagedCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) UpdateStatus(managedCertificate *networkinggkeiov1.ManagedCertificate) (*networkinggkeiov1.ManagedCertificate, error) {
	obj, err := c.Fake.
...
func (c *FakeManagedCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *networkinggkeiov1.ManagedCertificate, err error) {
	obj, err := c.Fake.
