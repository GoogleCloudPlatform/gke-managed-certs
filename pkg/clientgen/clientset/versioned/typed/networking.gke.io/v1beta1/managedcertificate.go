...
type ManagedCertificateInterface interface {
	Create(ctx context.Context, managedCertificate *v1beta1.ManagedCertificate, opts v1.CreateOptions) (*v1beta1.ManagedCertificate, error)
	Update(ctx context.Context, managedCertificate *v1beta1.ManagedCertificate, opts v1.UpdateOptions) (*v1beta1.ManagedCertificate, error)
	UpdateStatus(ctx context.Context, managedCertificate *v1beta1.ManagedCertificate, opts v1.UpdateOptions) (*v1beta1.ManagedCertificate, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ManagedCertificate, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ManagedCertificateList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ManagedCertificate, err error)
...
func newManagedCertificates(c *NetworkingV1beta1Client, namespace string) *managedCertificates {
...
func (c *managedCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ManagedCertificate, err error) {
	result = &v1beta1.ManagedCertificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ManagedCertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ManagedCertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) Create(ctx context.Context, managedCertificate *v1beta1.ManagedCertificate, opts v1.CreateOptions) (result *v1beta1.ManagedCertificate, err error) {
	result = &v1beta1.ManagedCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) Update(ctx context.Context, managedCertificate *v1beta1.ManagedCertificate, opts v1.UpdateOptions) (result *v1beta1.ManagedCertificate, err error) {
	result = &v1beta1.ManagedCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) UpdateStatus(ctx context.Context, managedCertificate *v1beta1.ManagedCertificate, opts v1.UpdateOptions) (result *v1beta1.ManagedCertificate, err error) {
	result = &v1beta1.ManagedCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedcertificates").
...
func (c *managedCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ManagedCertificate, err error) {
	result = &v1beta1.ManagedCertificate{}
