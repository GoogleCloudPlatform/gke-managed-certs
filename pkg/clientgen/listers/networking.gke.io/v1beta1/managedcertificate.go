...
type ManagedCertificateLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.ManagedCertificate, err error)
...
// List lists all ManagedCertificates in the indexer.
func (s *managedCertificateLister) List(selector labels.Selector) (ret []*v1beta1.ManagedCertificate, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.ManagedCertificate))
	})
	return ret, err
}
...
type ManagedCertificateNamespaceLister interface {
	...
	Get(name string) (*v1beta1.ManagedCertificate, error)
...
// List lists all ManagedCertificates in the indexer for a given namespace.
func (s managedCertificateNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.ManagedCertificate, err error) {
...
// Get retrieves the ManagedCertificate from the indexer for a given namespace and name.
func (s managedCertificateNamespaceLister) Get(name string) (*v1beta1.ManagedCertificate, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("managedcertificate"), name)
	}
	return obj.(*v1beta1.ManagedCertificate), nil
}
