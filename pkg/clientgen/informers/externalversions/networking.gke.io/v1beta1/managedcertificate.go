...
import (
	...
	networkinggkeiov1beta1 "github.com/GoogleCloudPlatform/gke-managed-certs/pkg/apis/networking.gke.io/v1beta1"
	...
	v1beta1 "github.com/GoogleCloudPlatform/gke-managed-certs/pkg/clientgen/listers/networking.gke.io/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1beta1().ManagedCertificates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1beta1().ManagedCertificates(namespace).Watch(context.TODO(), options)
			},
		},
		&networkinggkeiov1beta1.ManagedCertificate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *managedCertificateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkinggkeiov1beta1.ManagedCertificate{}, f.defaultInformer)
}

func (f *managedCertificateInformer) Lister() v1beta1.ManagedCertificateLister {
	return v1beta1.NewManagedCertificateLister(f.Informer().GetIndexer())
}
